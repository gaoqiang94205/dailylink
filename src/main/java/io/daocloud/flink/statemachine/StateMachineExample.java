package io.daocloud.flink.statemachine;/*
...
import io.daocloud.flink.statemachine.dfa.State;
import io.daocloud.flink.statemachine.event.Alert;
import io.daocloud.flink.statemachine.event.Event;
import io.daocloud.flink.statemachine.generator.EventsGeneratorSource;
import io.daocloud.flink.statemachine.kafka.EventDeSerializer;
...
public class StateMachineExample {
	...
	public static void main(String[] args) throws Exception {
		...
		if (params.has("kafka-topic")) {
			...
			String kafkaTopic = params.get("kafka-topic","flink");
			String brokers = params.get("brokers", "192.168.124.18:9092");
