package io.daocloud.flink.statemachine.kafka;/*
...
import io.daocloud.flink.statemachine.event.EventType;
...
public class EventDeSerializer implements DeserializationSchema<Event>, SerializationSchema<Event> {
	...
	public static void main(String[] args){
		Event event = new Event(EventType.b, 100);
		EventDeSerializer tools = new EventDeSerializer();
		byte[] result = tools.serialize(event);
